...
function AreaDaForma() {
    ...
    let areaForma = ((2 * alturaCm) - (0.1 * lajesAdjacentes) + larguraCm) * comprimentoVaoLivre;
    ...
    let volumeDeConcreto = alturaCm * larguraCm * comprimentoVaoLivre;
...
function calculandoVolumeDeConcreto() {
    ...
    let larguraVigaCm = larguraViga / 100; // Converter para metros
    let alturaVigaCm = alturaViga / 100; // Converter para metros
    let alturaLajeCm = alturaLaje / 100; // Converter para metros
